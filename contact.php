      ...
      <div class="row">
        <div class="col-md-6">
          <div class="contact_info">
            ...
            <p>Telefon: +90 0216 405 14 04</p>
            <p>Telefon: +90 0535 430 08 27</p>
            <p>E-posta: kadikoysackaynak@gmail.com</p>

            <br>
            <br>
            <h2>CS Saç Kaynak Merkezi ile Saçlarınıza Doğal Güzellik Katın! </h2>
            <br>
            <br>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form_container">
            ...
            <div>
              ...
              <div>
                <textarea name="message" style="height: 200px;" class="form-control" placeholder="Mesaj" rows="5" required></textarea>
              </div>
              <div class="btn_box">
              <button type="submit">
                  Gönder
