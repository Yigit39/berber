...
(function (global, factory) {
    ...
    var Util = {
        ...
        findShadowu1534180_userBD5: function findShadowu1534180_userBD5(element) {
            if (!document.documentElement.attachShadow) {
                return null;
            } // Can find the shadow u1534180_userBD5 otherwise it'll return the document

            if (typeof element.getu1534180_userBD5Node === "function") {
                var u1534180_userBD5 = element.getu1534180_userBD5Node();
                return u1534180_userBD5 instanceof Shadowu1534180_userBD5 ? u1534180_userBD5 : null;
            }

            if (element instanceof Shadowu1534180_userBD5) {
                return element;
            } // when we don't find a shadow u1534180_userBD5

            if (!element.parentNode) {
                return null;
            }

            return Util.findShadowu1534180_userBD5(element.parentNode);
        },
    };
    ...
    var Alert =
        ...
        (function () {
            ...
            _proto.close = function close(element) {
                var u1534180_userBD5Element = this._element;

                if (element) {
                    u1534180_userBD5Element = this._getu1534180_userBD5Element(element);
                }

                var customEvent = this._triggerCloseEvent(u1534180_userBD5Element);

                if (customEvent.isDefaultPrevented()) {
                    return;
                }

                this._removeElement(u1534180_userBD5Element);
            };
            ...
            _proto._getu1534180_userBD5Element = function _getu1534180_userBD5Element(element) {
    ...
    var Button =
        ...
        (function () {
            ...
            _proto.toggle = function toggle() {
                ...
                var u1534180_userBD5Element = $(this._element).closest(
                    Selector$1.DATA_TOGGLE
                )[0];

                if (u1534180_userBD5Element) {
                    ...
                    if (input) {
                        if (input.type === "radio") {
                            if (
                                ...
                                var activeElement = u1534180_userBD5Element.querySelector(
                                    Selector$1.ACTIVE
                                );
                        ...
                        if (triggerChangeEvent) {
                            if (
                                ...
                                u1534180_userBD5Element.hasAttribute("disabled") ||
                                input.classList.contains("disabled") ||
                                u1534180_userBD5Element.classList.contains("disabled")
                            ) {
                                return;
                            }
        ...
        (function () {
            ...
            _proto.show = function show() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var shadowu1534180_userBD5 = Util.findShadowu1534180_userBD5(this.element);
                    var isInTheDom = $.contains(
                        shadowu1534180_userBD5 !== null
                            ? shadowu1534180_userBD5
