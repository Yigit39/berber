...
<body>
    <div class="container form-container">
        ...
        <form action="dosya_yukle3.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            if (count($dosyalar) > 0) {
                ...
                echo '<thead class="thead-dark"><tr><th>Önizleme</th><th>Dosya Adı</th><th>İşlemler</th></tr></thead>';
                echo '<tbody>';
                ...
                foreach ($dosyalar as $dosya) {
                    ...
                    echo '<tr>';
                    echo '<td><img src="../images/salon/' . htmlspecialchars($dosya) . '" alt="' . htmlspecialchars($dosya) . '" style="max-width: 100px; max-height: 100px;"></td>';
                    echo '<td>' . htmlspecialchars($dosya) . '</td>';
                    echo '<td><a href="dosya_sil3.php?dosya=' . urlencode($dosya) . '" class="btn btn-danger btn-sm">Sil</a></td>';
                    echo '</tr>';
                }
